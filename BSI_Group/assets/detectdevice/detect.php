		...
		if (self::$detect->isAndroidOS()) {
			if (self::$detect->version('Android') !== false) {
				...
				switch (true) {
					...
					case self::$detect->version('Android') >= 4.3: $codeName = ' JellyBean'; break;
					case self::$detect->version('Android') >= 4.2: $codeName = ' JellyBean'; break;
					case self::$detect->version('Android') >= 4.1: $codeName = ' JellyBean'; break;
					case self::$detect->version('Android') >= 4.0: $codeName = ' IceCreamSandwich'; break;
